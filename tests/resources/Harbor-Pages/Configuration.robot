...
Update A Label
    [Arguments]  ${labelname}
    Retry Element Click  xpath=//clr-dg-row[contains(.,'${labelname}')]//clr-checkbox-wrapper//label[contains(@class,'clr-control-label')]
    Sleep  1
...
Select Distribution
    [Arguments]    ${name}
    Retry Element Click    //clr-dg-row[contains(.,'${name}')]//clr-checkbox-wrapper/label[contains(@class,'clr-control-label')]
