...
${replication_xpath}  //clr-vertical-nav//a[@href='/harbor/replications']
...
${nav_to_registries}  //clr-vertical-nav//a[@href='/harbor/registries']
${nav_to_replications}  //clr-vertical-nav//a[@href='/harbor/replications']
...
${replication_task_line_1}  //clr-datagrid//clr-dg-row[1]//clr-checkbox-wrapper/label[contains(@class,'clr-control-label')]
