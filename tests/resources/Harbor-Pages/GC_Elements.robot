...
*** Variables ***
${gc_page_xpath}  //clr-main-container//clr-vertical-nav//a[@href='/harbor/clearing-job']
${gc_now_button}  //*[@id='gc-now']
${dry_run_button}  //*[@id='gc-dry-run']
${checkbox_delete_untagged_artifacts}  //gc-config//clr-toggle-wrapper/label[@for='delete_untagged']
